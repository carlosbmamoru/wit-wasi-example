...
macro_rules! __export_world_hello_cabi{
...
#[doc(hidden)]
pub(crate) use __export_world_hello_cabi;
...
macro_rules! __export_hello_impl {
  ...
  $($path_to_types_root)*::__export_world_hello_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
#[link_section = "component-type:wit-bindgen:0.20.0:hello:encoded world"]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x04\x01\x15component:guest/hello\x04\0\x0b\x0b\
\x01\0\x05hello\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\
\x070.201.0\x10wit-bindgen-rust\x060.20.0";
